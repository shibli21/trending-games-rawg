...
const Button = ({ children, icon, isLoading }: Props) => {
  return (
    <button
      type="button"
      className="text-white font-medium text-sm px-5 py-2.5 text-center inline-flex justify-center items-center bg-purple-500 rounded-lg shadow-md hover:bg-purple-600   focus:outline-none"
    >
      {!isLoading ? (
